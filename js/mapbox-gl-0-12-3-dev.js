(function (f) {
  ...
  return (function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      "../style/layout_properties": 42,
      "../style/style_declaration_set": 48,
      "./buffer": 2,
      "./circle_bucket": 3,
      "./element_groups": 4,
      "./fill_bucket": 6,
    ...
    8: [function (require, module, exports) {
      ...
      function SymbolInstance(e, t, o, i, a, s, n, r, l, h, c, u) {
        this.x = e.x, this.y = e.y, this.hasText = !!o, this.hasIcon = !!i, this.hasText && (this.glyphQuads = s ? getGlyphQuads(e, o, n, t, a, l) : [], this.textCollisionFeature = new CollisionFeature(t, e, o, n, r, l)), this.hasIcon && (this.iconQuads = s ? getIconQuads(e, i, h, t, a, u) : [], this.iconCollisionFeature = new CollisionFeature(t, e, i, h, c, u))
      }
      ...
      SymbolBucket.prototype.shaders = {
        ...
        var i = 512 * this.overscaling,
          a = 4096;
        this.tilePixelRatio = a / i, this.compareText = {}, this.symbolInstances = [], this.iconsNeedLinear = !1;
        ...
        for (var c = "right" === s["text-justify"] ? 1 : "left" === s["text-justify"] ? 0 : .5, u = 24, m = s["text-line-height"] * u, x = "line" !== s["symbol-placement"] ? s["text-max-width"] * u : 0, p = s["text-letter-spacing"] * u, y = [s["text-offset"][0] * u, s["text-offset"][1] * u], d = s["text-font"].join(","), g = [], f = 0; f < n.length; f++) g.push(n[f].loadGeometry());
        if ("line" === s["symbol-placement"]) {
          var b = mergeLines(n, r, g);
          g = b.geometries, n = b.features, r = b.textFeatures
        }
        for (var v, B, S = 0; S < n.length; S++)
          if (g[S]) {
            if (v = r[S] ? shapeText(r[S], t[d], x, m, l, h, c, p, y) : null, s["icon-image"]) {
              var I = resolveTokens(n[S].properties, s["icon-image"]),
                M = o[I];
              B = shapeIcon(M, s), M && (void 0 === this.sdfIcons ? this.sdfIcons = M.sdf : this.sdfIcons !== M.sdf && console.warn("Style sheet warning: Cannot mix SDF and non-SDF icons in one buffer"), 1 !== M.pixelRatio && (this.iconsNeedLinear = !0))
            } else B = null;
            (v || B) && this.addFeature(g[S], v, B)
          }
        ...
        var i = this.layoutProperties,
          a = 24,
          s = i["text-size"] / a,
          n = void 0 !== i["text-max-size"] ? i["text-max-size"] : i["text-size"],
          r = this.tilePixelRatio * s,
          l = this.tilePixelRatio * n / a,
          h = this.tilePixelRatio * i["icon-size"],
          ...
          y = "map" === i["text-rotation-alignment"] && "line" === i["symbol-placement"],
          d = "map" === i["icon-rotation-alignment"] && "line" === i["symbol-placement"],
          g = i["text-allow-overlap"] || i["icon-allow-overlap"] || i["text-ignore-placement"] || i["icon-ignore-placement"],
          f = "line" === i["symbol-placement"],
          b = c / 2;
        f && (e = clipLine(e, 0, 0, 4096, 4096));
        for (var v = 0; v < e.length; v++)
          for (var B = e[v], S = f ? getAnchors(B, c, p, t, o, a, l, this.overscaling) : [new Anchor(B[0].x, B[0].y, 0)], I = 0, M = S.length; M > I; I++) {
            var k = S[I];
            if (!(t && f && this.anchorIsTooClose(t.text, b, k))) {
              var T = !(k.x < 0 || k.x > 4096 || k.y < 0 || k.y > 4096);
              if (!u || T) {
                var F = T || g;
                this.symbolInstances.push(new SymbolInstance(k, B, t, o, i, F, r, m, y, h, x, d))
              }
            }
          }
        ...
        for (var m = 0; m < this.symbolInstances.length; m++) {
          var x = this.symbolInstances[m],
            ...
            d = a["text-optional"] || !p,
            g = a["icon-optional"] || !y,
            f = p && !a["text-allow-overlap"] ? e.placeCollisionFeature(x.textCollisionFeature) : e.minScale,
            b = y && !a["icon-allow-overlap"] ? e.placeCollisionFeature(x.iconCollisionFeature) : e.minScale;
          d || g ? !g && f ? f = Math.max(b, f) : !d && b && (b = Math.max(b, f)) : b = f = Math.max(b, f), p && (a["text-ignore-placement"] || e.insertCollisionFeature(x.textCollisionFeature, f), s >= f && this.addSymbols("glyph", x.glyphQuads, f, a["text-keep-upright"], n, e.angle)), y && (a["icon-ignore-placement"] || e.insertCollisionFeature(x.iconCollisionFeature, b), s >= b && this.addSymbols("icon", x.iconQuads, b, a["icon-keep-upright"], r, e.angle))
        }
        o && this.addToDebugBuffers(e)
      }, SymbolBucket.prototype.addSymbols = function (e, t, o, i, a, s) {
        for (var n = this.makeRoomFor(e, 4 * t.length), r = this[this.getAddMethodName(e, "element")].bind(this), l = this[this.getAddMethodName(e, "vertex")].bind(this), h = this.zoom, c = Math.max(Math.log(o) / Math.LN2 + h, 0), u = 0; u < t.length; u++) {
          var m = t[u],
            x = m.angle,
          ...
          if (!(i && a && (p <= Math.PI / 2 || p > 3 * Math.PI / 2))) {
            var y = m.tl,
              ...
              b = m.tex,
              v = m.anchorPoint,
              B = Math.max(h + Math.log(m.minScale) / Math.LN2, c),
              S = Math.min(h + Math.log(m.maxScale) / Math.LN2, 25);
            if (!(B >= S)) {
              B === c && (B = 0);
              var I = l(v.x, v.y, y.x, y.y, b.x, b.y, B, S, c) - n.vertexStartIndex;
              l(v.x, v.y, d.x, d.y, b.x + b.w, b.y, B, S, c), l(v.x, v.y, g.x, g.y, b.x, b.y + b.h, B, S, c), l(v.x, v.y, f.x, f.y, b.x + b.w, b.y + b.h, B, S, c), n.vertexLength += 4, r(I, I + 1, I + 2), r(I + 1, I + 2, I + 3), n.elementLength += 2
            }
          }
        }
          ...
          for (var s = 0; 2 > s; s++) {
            ...
            if (n)
              for (var r = n.boxes, l = 0; l < r.length; l++) {
                var h = r[l],
                  c = h.anchorPoint,
                  u = new Point(h.x1, h.y1 * i)._rotate(o),
                  ...
                  d = Math.max(0, Math.min(25, this.zoom + Math.log(h.placementScale) / Math.LN2));
                this.addCollisionBoxVertex(c, u, y, d), this.addCollisionBoxVertex(c, m, y, d), this.addCollisionBoxVertex(c, m, y, d), this.addCollisionBoxVertex(c, p, y, d), this.addCollisionBoxVertex(c, p, y, d), this.addCollisionBoxVertex(c, x, y, d), this.addCollisionBoxVertex(c, x, y, d), this.addCollisionBoxVertex(c, u, y, d), t.vertexLength += 8
              }
          }
      };
}, {
      "../symbol/anchor": 51,
      "../symbol/clip_line": 54,
      "../symbol/collision_feature": 56,
      "../symbol/get_anchors": 58,
      "../symbol/mergelines": 61,
      "../symbol/quads": 62,
      "../symbol/resolve_text": 63,
      "../symbol/shaping": 64,
      "../util/token": 93,
      "../util/util": 94,
      "./bucket": 1,
    ...
    14: [function (require, module, exports) {
      ...
      "./style/style": 45,
      "./ui/control/attribution": 67,
      "./ui/control/control": 68,
      "./ui/control/navigation": 69,
      "./ui/map": 79,
      "./ui/popup": 80,
      "./util/ajax": 82,
      "./util/browser": 83,
    ...
    15: [function (require, module, exports) {
      ...
      function drawBackground(e, t, r) {
        var i, a = e.gl,
          n = e.transform,
          o = r.paint["background-color"],
          u = r.paint["background-pattern"],
          l = r.paint["background-opacity"],
          s = u ? e.spriteAtlas.getPosition(u.from, !0) : null,
          f = u ? e.spriteAtlas.getPosition(u.to, !0) : null;
        if (e.setDepthSublayer(0), s && f) {
          if (e.isOpaquePass) return;
          i = e.patternShader, a.switchShader(i), a.uniform1i(i.u_image, 0), a.uniform2fv(i.u_pattern_tl_a, s.tl), a.uniform2fv(i.u_pattern_br_a, s.br), a.uniform2fv(i.u_pattern_tl_b, f.tl), a.uniform2fv(i.u_pattern_br_b, f.br), a.uniform1f(i.u_opacity, l), a.uniform1f(i.u_mix, u.t);
          var c = 4096 / n.tileSize / Math.pow(2, 0);
          a.uniform2fv(i.u_patternscale_a, [1 / (s.size[0] * c * u.fromScale), 1 / (s.size[1] * c * u.fromScale)]), a.uniform2fv(i.u_patternscale_b, [1 / (f.size[0] * c * u.toScale), 1 / (f.size[1] * c * u.toScale)]), e.spriteAtlas.bind(a, !0)
        } else {
          if (e.isOpaquePass !== (1 === o[3])) return;
          i = e.fillShader, a.switchShader(i), a.uniform4fv(i.u_color, o)
        }
        a.disable(a.STENCIL_TEST), a.bindBuffer(a.ARRAY_BUFFER, e.tileExtentBuffer), a.vertexAttribPointer(i.a_pos, e.tileExtentBuffer.itemSize, a.SHORT, !1, 0, 0);
        for (var _ = pyramid.coveringTiles(n), p = 0; p < _.length; p++) a.setPosMatrix(e.calculatePosMatrix(_[p])), a.drawArrays(a.TRIANGLE_STRIP, 0, e.tileExtentBuffer.itemCount);
        a.enable(a.STENCIL_TEST), a.stencilMask(0), a.stencilFunc(a.EQUAL, 128, 128)
      }
    ...
    16: [function (require, module, exports) {
      ...
      function drawCircles(e, r, t, i) {
        if (!e.isOpaquePass) {
          var a = e.gl,
            l = e.circleShader;
          e.gl.switchShader(l), e.setDepthSublayer(0), e.depthMask(!1), a.disable(a.STENCIL_TEST);
          var s = 1 / browser.devicePixelRatio / t.paint["circle-radius"];
          a.uniform4fv(l.u_color, t.paint["circle-color"]), a.uniform1f(l.u_blur, Math.max(t.paint["circle-blur"], s)), a.uniform1f(l.u_size, t.paint["circle-radius"]);
          for (var c = 0; c < i.length; c++) {
            var n = i[c],
              o = r.getTile(n);
            if (o.buffers && o.elementGroups[t.ref || t.id].circle) {
              var u = o.elementGroups[t.ref || t.id].circle,
                f = o.buffers.circleVertex,
                d = o.buffers.circleElement;
              a.setPosMatrix(e.translatePosMatrix(e.calculatePosMatrix(n, r.maxzoom), o, t.paint["circle-translate"], t.paint["circle-translate-anchor"])), a.setExMatrix(e.transform.exMatrix);
              for (var m = 0; m < u.groups.length; m++) {
                var x = u.groups[m],
                  b = x.vertexStartIndex * f.itemSize;
                f.bind(a), f.setAttribPointers(a, l, b), d.bind(a);
                var p = 3 * x.elementLength,
                  S = x.elementStartIndex * d.itemSize;
                a.drawElements(a.TRIANGLES, p, a.UNSIGNED_SHORT, S)
              }
            }
          }
    ...
    17: [function (require, module, exports) {
      ...
      function drawCollisionDebug(o, e, r, i) {
        if (i.buffers && i.elementGroups[e.ref || e.id]) {
          var s = i.elementGroups[e.ref || e.id].collisionBox;
          if (s) {
            var l = o.gl,
              t = i.buffers.collisionBoxVertex,
              a = o.collisionBoxShader,
              n = o.calculatePosMatrix(r);
            l.enable(l.STENCIL_TEST), o.enableTileClippingMask(r), l.switchShader(a, n), t.bind(l), t.setAttribPointers(l, a, 0), l.lineWidth(1), l.uniform1f(a.u_scale, Math.pow(2, o.transform.zoom - i.coord.z)), l.uniform1f(a.u_zoom, 10 * o.transform.zoom), l.uniform1f(a.u_maxzoom, 10 * (i.coord.z + 1));
            var u = s.groups[0].vertexStartIndex,
    ...
    18: [function (require, module, exports) {
      ...
      function drawDebugTile(e, r) {
        var t = e.gl,
          i = e.debugShader;
        t.switchShader(i, e.calculatePosMatrix(r)), t.bindBuffer(t.ARRAY_BUFFER, e.debugBuffer), t.vertexAttribPointer(i.a_pos, e.debugBuffer.itemSize, t.SHORT, !1, 0, 0), t.uniform4f(i.u_color, 1, 0, 0, 1), t.lineWidth(4), t.drawArrays(t.LINE_STRIP, 0, e.debugBuffer.itemCount);
        var u = textVertices(r.toString(), 50, 200, 5);
        t.bindBuffer(t.ARRAY_BUFFER, e.debugTextBuffer), t.bufferData(t.ARRAY_BUFFER, new Int16Array(u), t.STREAM_DRAW), t.vertexAttribPointer(i.a_pos, e.debugTextBuffer.itemSize, t.SHORT, !1, 0, 0), t.lineWidth(8 * browser.devicePixelRatio), t.uniform4f(i.u_color, 1, 1, 1, 1), t.drawArrays(t.LINES, 0, u.length / e.debugTextBuffer.itemSize), t.lineWidth(2 * browser.devicePixelRatio), t.uniform4f(i.u_color, 0, 0, 0, 1), t.drawArrays(t.LINES, 0, u.length / e.debugTextBuffer.itemSize)
      }
    ...
    19: [function (require, module, exports) {
      ...
      function draw(e, t, r, i) {
        var a = e.gl,
          l = r.paint["fill-color"],
          n = r.paint["fill-pattern"],
          o = r.paint["fill-outline-color"];
        if (n ? !e.isOpaquePass : e.isOpaquePass === (1 === l[3]))
          for (var f = 0; f < i.length; f++) drawFill(e, t, r, i[f]);
        if (!e.isOpaquePass && r.paint["fill-antialias"] && (!r.paint["fill-pattern"] || o)) {
          a.switchShader(e.outlineShader), a.lineWidth(2 * browser.devicePixelRatio * 10), o ? e.setDepthSublayer(2) : e.setDepthSublayer(0), a.uniform2f(e.outlineShader.u_world, a.drawingBufferWidth, a.drawingBufferHeight), a.uniform4fv(e.outlineShader.u_color, o ? o : l);
          for (var s = 0; s < i.length; s++) drawStroke(e, t, r, i[s])
        }
      }

      function drawFill(e, t, r, i) {
        var a = t.getTile(i);
        if (a.buffers && a.elementGroups[r.ref || r.id]) {
          var l = a.elementGroups[r.ref || r.id].fill,
            n = e.gl,
            o = r.paint["fill-color"],
            f = r.paint["fill-pattern"],
            s = r.paint["fill-opacity"],
            u = e.calculatePosMatrix(i, t.maxzoom),
            p = e.translatePosMatrix(u, a, r.paint["fill-translate"], r.paint["fill-translate-anchor"]);
          e.setDepthSublayer(1), n.stencilMask(7), n.clear(n.STENCIL_BUFFER_BIT), e.enableTileClippingMask(i), n.stencilOpSeparate(n.FRONT, n.KEEP, n.KEEP, n.INCR_WRAP), n.stencilOpSeparate(n.BACK, n.KEEP, n.KEEP, n.DECR_WRAP), n.colorMask(!1, !1, !1, !1), e.depthMask(!1), n.switchShader(e.fillShader, p);
          var d = a.buffers.fillVertex;
          d.bind(n);
          var c = a.buffers.fillElement;
          c.bind(n);
          for (var S = 0; S < l.groups.length; S++) {
            var m = l.groups[S],
              h = m.vertexStartIndex * d.itemSize;
            d.setAttribPointers(n, e.fillShader, h);
            var v = 3 * m.elementLength,
              _ = m.elementStartIndex * c.itemSize;
            n.drawElements(n.TRIANGLES, v, n.UNSIGNED_SHORT, _)
          }
          n.colorMask(!0, !0, !0, !0), e.depthMask(!0), n.stencilOp(n.KEEP, n.KEEP, n.KEEP), n.stencilMask(0);
          var E;
          if (f) {
            var b = e.spriteAtlas.getPosition(f.from, !0),
              w = e.spriteAtlas.getPosition(f.to, !0);
            if (!b || !w) return;
            E = e.patternShader, n.switchShader(E, u), n.uniform1i(E.u_image, 0), n.uniform2fv(E.u_pattern_tl_a, b.tl), n.uniform2fv(E.u_pattern_br_a, b.br), n.uniform2fv(E.u_pattern_tl_b, w.tl), n.uniform2fv(E.u_pattern_br_b, w.br), n.uniform1f(E.u_opacity, s), n.uniform1f(E.u_mix, f.t);
            var x = Math.pow(2, e.transform.tileZoom - a.coord.z),
              P = 4096 / a.tileSize,
              g = [b.size[0] * f.fromScale / x, b.size[1] * f.fromScale / x],
              z = [w.size[0] * f.toScale / x, w.size[1] * f.toScale / x];
            n.uniform2fv(E.u_patternscale_a, [1 / (g[0] * P), 1 / (g[1] * P)]), n.uniform2fv(E.u_patternscale_b, [1 / (z[0] * P), 1 / (z[1] * P)]);
            var M = a.tileSize % g[0] * (a.coord.x + i.w * Math.pow(2, a.coord.z)) / g[0],
              R = a.tileSize % g[1] * a.coord.y / g[1],
              A = a.tileSize % z[0] * (a.coord.x + i.w * Math.pow(2, a.coord.z)) / z[0],
              T = a.tileSize % z[1] * a.coord.y / z[1];
            n.uniform2fv(E.u_offset_a, [M, R]), n.uniform2fv(E.u_offset_b, [A, T]), e.spriteAtlas.bind(n, !0)
          } else E = e.fillShader, n.switchShader(E, u), n.uniform4fv(E.u_color, o);
          n.stencilFunc(n.NOTEQUAL, 0, 7), n.bindBuffer(n.ARRAY_BUFFER, e.tileExtentBuffer), n.vertexAttribPointer(E.a_pos, e.tileExtentBuffer.itemSize, n.SHORT, !1, 0, 0), n.drawArrays(n.TRIANGLE_STRIP, 0, e.tileExtentBuffer.itemCount), n.stencilMask(0)
        }
      }

      function drawStroke(e, t, r, i) {
        var a = t.getTile(i);
        if (a.buffers && a.elementGroups[r.ref || r.id]) {
          var l = e.gl,
            n = a.elementGroups[r.ref || r.id].fill;
          l.setPosMatrix(e.translatePosMatrix(e.calculatePosMatrix(i, t.maxzoom), a, r.paint["fill-translate"], r.paint["fill-translate-anchor"]));
          var o = a.buffers.fillVertex,
            f = a.buffers.fillSecondElement;
          o.bind(l), f.bind(l), e.enableTileClippingMask(i);
          for (var s = 0; s < n.groups.length; s++) {
            var u = n.groups[s],
              p = u.vertexStartIndex * o.itemSize;
            o.setAttribPointers(l, e.outlineShader, p);
            var d = 2 * u.secondElementLength,
              c = u.secondElementStartIndex * f.itemSize;
            l.drawElements(l.LINES, d, l.UNSIGNED_SHORT, c)
          }
        }
      }
    ...
    20: [function (require, module, exports) {
      ...
      module.exports = function (t, i, e, a) {
        if (!t.isOpaquePass) {
          t.setDepthSublayer(0), t.depthMask(!1);
          for (var r = !1, n = 0; n < a.length; n++)
            if (i.getTile(a[n]).hasLayerData(e)) {
              r = !0;
              break
            }
          if (r) {
            ...
            if (!(e.paint["line-width"] <= 0)) {
              var o = 1 / browser.devicePixelRatio,
                l = e.paint["line-blur"] + o,
                u = e.paint["line-width"] / 2,
                s = -1,
                m = 0,
                _ = 0;
              e.paint["line-gap-width"] > 0 && (s = e.paint["line-gap-width"] / 2 + .5 * o, u = e.paint["line-width"], m = s - o / 2);
              var h = m + u + o / 2 + _,
                p = e.paint["line-color"],
                d = t.transform,
                v = mat2.create();
              mat2.scale(v, v, [1, Math.cos(d._pitch)]), mat2.rotate(v, v, t.transform.angle);
              var c, x, b, g, w, S = Math.sqrt(d.height * d.height / 4 * (1 + d.altitude * d.altitude)),
                M = d.height / 2 * Math.tan(d._pitch),
                z = (S + M) / S - 1,
                y = e.paint["line-dasharray"],
                A = e.paint["line-pattern"];
              if (y) c = t.linesdfpatternShader, f.switchShader(c), f.uniform2fv(c.u_linewidth, [h, s]), f.uniform1f(c.u_blur, l), f.uniform4fv(c.u_color, p), x = t.lineAtlas.getDash(y.from, "round" === e.layout["line-cap"]), b = t.lineAtlas.getDash(y.to, "round" === e.layout["line-cap"]), t.lineAtlas.bind(f), f.uniform1f(c.u_tex_y_a, x.y), f.uniform1f(c.u_tex_y_b, b.y), f.uniform1i(c.u_image, 0), f.uniform1f(c.u_mix, y.t), f.uniform1f(c.u_extra, z), f.uniform1f(c.u_offset, -e.paint["line-offset"]), f.uniformMatrix2fv(c.u_antialiasingmatrix, !1, v);
              else if (A) {
                if (g = t.spriteAtlas.getPosition(A.from, !0), w = t.spriteAtlas.getPosition(A.to, !0), !g || !w) return;
                t.spriteAtlas.bind(f, !0), c = t.linepatternShader, f.switchShader(c), f.uniform2fv(c.u_linewidth, [h, s]), f.uniform1f(c.u_blur, l), f.uniform2fv(c.u_pattern_tl_a, g.tl), f.uniform2fv(c.u_pattern_br_a, g.br), f.uniform2fv(c.u_pattern_tl_b, w.tl), f.uniform2fv(c.u_pattern_br_b, w.br), f.uniform1f(c.u_fade, A.t), f.uniform1f(c.u_opacity, e.paint["line-opacity"]), f.uniform1f(c.u_extra, z), f.uniform1f(c.u_offset, -e.paint["line-offset"]), f.uniformMatrix2fv(c.u_antialiasingmatrix, !1, v)
              } else c = t.lineShader, f.switchShader(c), f.uniform2fv(c.u_linewidth, [h, s]), f.uniform1f(c.u_blur, l), f.uniform1f(c.u_extra, z), f.uniform1f(c.u_offset, -e.paint["line-offset"]), f.uniformMatrix2fv(c.u_antialiasingmatrix, !1, v), f.uniform4fv(c.u_color, p);
              for (var P = 0; P < a.length; P++) {
                var T = a[P],
                  E = i.getTile(T),
                  R = E.buffers && E.elementGroups[e.ref || e.id] && E.elementGroups[e.ref || e.id].line;
                if (R) {
                  t.enableTileClippingMask(T);
                  var D = t.translatePosMatrix(t.calculatePosMatrix(T, i.maxzoom), E, e.paint["line-translate"], e.paint["line-translate-anchor"]);
                  f.setPosMatrix(D), f.setExMatrix(t.transform.exMatrix);
                  var q = t.transform.scale / (1 << T.z) / (4096 / E.tileSize);
                  if (y) {
                    var G = E.tileSize / t.transform.tileSize,
                      I = Math.pow(2, Math.floor(Math.log(t.transform.scale) / Math.LN2) - T.z) / 8 * G,
                      L = [I / x.width / y.fromScale, -x.height / 2],
                      N = t.lineAtlas.width / (y.fromScale * x.width * 256 * browser.devicePixelRatio) / 2,
                      k = [I / b.width / y.toScale, -b.height / 2],
                      O = t.lineAtlas.width / (y.toScale * b.width * 256 * browser.devicePixelRatio) / 2;
                    f.uniform1f(c.u_ratio, q), f.uniform2fv(c.u_patternscale_a, L), f.uniform2fv(c.u_patternscale_b, k), f.uniform1f(c.u_sdfgamma, Math.max(N, O))
                  } else if (A) {
                    var H = 4096 / E.tileSize / Math.pow(2, t.transform.tileZoom - T.z);
                    f.uniform1f(c.u_ratio, q), f.uniform2fv(c.u_pattern_size_a, [g.size[0] * H * A.fromScale, w.size[1]]), f.uniform2fv(c.u_pattern_size_b, [w.size[0] * H * A.toScale, w.size[1]])
                  } else f.uniform1f(c.u_ratio, q);
                  var B = E.buffers.lineVertex;
                  B.bind(f);
                  var C = E.buffers.lineElement;
                  C.bind(f);
                  for (var U = 0; U < R.groups.length; U++) {
                    var V = R.groups[U],
                      Y = V.vertexStartIndex * B.itemSize;
                    f.vertexAttribPointer(c.a_pos, 2, f.SHORT, !1, 8, Y + 0), f.vertexAttribPointer(c.a_data, 4, f.BYTE, !1, 8, Y + 4);
                    var Z = 3 * V.elementLength,
                      j = V.elementStartIndex * C.itemSize;
                    f.drawElements(f.TRIANGLES, Z, f.UNSIGNED_SHORT, j)
                  }
                }
              }
            }
    ...
    21: [function (require, module, exports) {
      ...
      function drawRaster(t, r, e, a) {
        if (!t.isOpaquePass) {
          var i = t.gl;
          i.depthFunc(i.LESS);
          for (var o = a.length - 1; o >= 0; o--) drawRasterTile(t, r, e, a[o]);
    ...
    22: [function (require, module, exports) {
      ...
      function drawSymbols(e, t, a, r) {
        if (!e.isOpaquePass) {
          var i = !(a.layout["text-allow-overlap"] || a.layout["icon-allow-overlap"] || a.layout["text-ignore-placement"] || a.layout["icon-ignore-placement"]),
            o = e.gl;
          i && o.disable(o.STENCIL_TEST), e.setDepthSublayer(0), e.depthMask(!1), o.disable(o.DEPTH_TEST);
          for (var l, n, s, f = 0; f < r.length; f++) l = t.getTile(r[f]), l.buffers && (n = l.elementGroups[a.ref || a.id], n && n.icon.groups.length && (s = e.calculatePosMatrix(r[f], t.maxzoom), e.enableTileClippingMask(r[f]), drawSymbol(e, a, s, l, n.icon, "icon", n.sdfIcons, n.iconsNeedLinear)));
          for (var m = 0; m < r.length; m++) l = t.getTile(r[m]), l.buffers && (n = l.elementGroups[a.ref || a.id], n && n.glyph.groups.length && (s = e.calculatePosMatrix(r[m], t.maxzoom), e.enableTileClippingMask(r[m]), drawSymbol(e, a, s, l, n.glyph, "text", !0, !1)));
          for (var u = 0; u < r.length; u++) l = t.getTile(r[u]), e.enableTileClippingMask(r[u]), drawCollisionDebug(e, a, r[u], l);
          i && o.enable(o.STENCIL_TEST), o.enable(o.DEPTH_TEST)
        }
      }

      function drawSymbol(e, t, a, r, i, o, l, n) {
        var s = e.gl;
        a = e.translatePosMatrix(a, r, t.paint[o + "-translate"], t.paint[o + "-translate-anchor"]);
        var f, m, u, d = e.transform,
          p = "map" === t.layout[o + "-rotation-alignment"],
          h = p;
        h ? (f = mat4.create(), m = r.tileExtent / r.tileSize / Math.pow(2, e.transform.zoom - r.coord.z), u = 1 / Math.cos(d._pitch)) : (f = mat4.clone(e.transform.exMatrix), m = e.transform.altitude, u = 1), mat4.scale(f, f, [m, m, 1]);
        var g = t.paint[o + "-size"],
          c = g / defaultSizes[o];
        mat4.scale(f, f, [c, c, 1]);
        var S, b, x, v, T = Math.sqrt(d.height * d.height / 4 * (1 + d.altitude * d.altitude)),
          _ = d.height / 2 * Math.tan(d._pitch),
          z = (T + _) / T - 1,
          w = "text" === o;
        if (w || e.style.sprite.loaded()) {
          if (s.activeTexture(s.TEXTURE0), S = l ? e.sdfShader : e.iconShader, w) e.glyphAtlas.updateTexture(s), b = r.buffers.glyphVertex, x = r.buffers.glyphElement, v = [e.glyphAtlas.width / 4, e.glyphAtlas.height / 4];
          else {
            var y = e.options.rotating || e.options.zooming,
              E = 1 !== c || browser.devicePixelRatio !== e.spriteAtlas.pixelRatio || n,
              M = p || e.transform.pitch;
            e.spriteAtlas.bind(s, l || y || E || M), b = r.buffers.iconVertex, x = r.buffers.iconElement, v = [e.spriteAtlas.width / 4, e.spriteAtlas.height / 4]
          }
          s.switchShader(S, a, f), s.uniform1i(S.u_texture, 0), s.uniform2fv(S.u_texsize, v), s.uniform1i(S.u_skewed, h), s.uniform1f(S.u_extra, z);
          var I = Math.log(g / i[o + "-size"]) / Math.LN2 || 0;
          s.uniform1f(S.u_zoom, 10 * (e.transform.zoom - I));
          var A = e.frameHistory.getFadeProperties(300);
          s.uniform1f(S.u_fadedist, 10 * A.fadedist), s.uniform1f(S.u_minfadezoom, Math.floor(10 * A.minfadezoom)), s.uniform1f(S.u_maxfadezoom, Math.floor(10 * A.maxfadezoom)), s.uniform1f(S.u_fadezoom, 10 * (e.transform.zoom + A.bump));
          var N, P, L, R;
          if (x.bind(s), l) {
            var D = 8,
              G = 1.19,
              C = 6,
              H = .105 * defaultSizes[o] / g / browser.devicePixelRatio;
            if (t.paint[o + "-halo-width"]) {
              s.uniform1f(S.u_gamma, (t.paint[o + "-halo-blur"] * G / c / D + H) * u), s.uniform4fv(S.u_color, t.paint[o + "-halo-color"]), s.uniform1f(S.u_buffer, (C - t.paint[o + "-halo-width"] / c) / D);
              for (var k = 0; k < i.groups.length; k++) N = i.groups[k], P = N.vertexStartIndex * b.itemSize, b.bind(s), b.setAttribPointers(s, S, P), L = 3 * N.elementLength, R = N.elementStartIndex * x.itemSize, s.drawElements(s.TRIANGLES, L, s.UNSIGNED_SHORT, R)
            }
            s.uniform1f(S.u_gamma, H * u), s.uniform4fv(S.u_color, t.paint[o + "-color"]), s.uniform1f(S.u_buffer, .75);
            for (var q = 0; q < i.groups.length; q++) N = i.groups[q], P = N.vertexStartIndex * b.itemSize, b.bind(s), b.setAttribPointers(s, S, P), L = 3 * N.elementLength, R = N.elementStartIndex * x.itemSize, s.drawElements(s.TRIANGLES, L, s.UNSIGNED_SHORT, R)
          } else {
            s.uniform1f(S.u_opacity, t.paint["icon-opacity"]);
            for (var O = 0; O < i.groups.length; O++) N = i.groups[O], P = N.vertexStartIndex * b.itemSize, b.bind(s), b.setAttribPointers(s, S, P), L = 3 * N.elementLength, R = N.elementStartIndex * x.itemSize, s.drawElements(s.TRIANGLES, L, s.UNSIGNED_SHORT, R)
          }
        }
      }
      ...
      exports.extend = function (r) {
        ...
        return r.lineWidth = function (i) {
          ...
          if (this.currentShader !== t) {
            ...
            for (var a = this.currentShader ? this.currentShader.attributes : [], h = t.attributes, s = 0; s < a.length; s++) h.indexOf(a[s]) < 0 && this.disableVertexAttribArray(a[s]);
            for (var n = 0; n < h.length; n++) a.indexOf(h[n]) < 0 && this.enableVertexAttribArray(h[n]);
            this.currentShader = t
          }
          void 0 !== e && r.setPosMatrix(e), void 0 !== i && r.setExMatrix(i)
        }, r.setPosMatrix = function (r) {
          var t = this.currentShader;
          t.posMatrix !== r && (this.uniformMatrix4fv(t.u_matrix, !1, r), t.posMatrix = r)
        }, r.setExMatrix = function (r) {
          var t = this.currentShader;
          r && t.exMatrix !== r && t.u_exmatrix && (this.uniformMatrix4fv(t.u_exmatrix, !1, r), t.exMatrix = r)
    ...
    26: [function (require, module, exports) {
      ...
      function Painter(t, e) {
        this.gl = glutil.extend(t), this.transform = e, this.reusableTextures = {}, this.preFbos = {}, this.frameHistory = new FrameHistory, this.setup(), this.numSublayers = 3, this.depthEpsilon = 1 / Math.pow(2, 16)
      }
      ...
      module.exports = Painter, Painter.prototype.resize = function (t, e) {
        ...
        var i = this.gl;
        i.colorMask(!1, !1, !1, !1), this.depthMask(!1), i.disable(i.DEPTH_TEST), i.stencilMask(248), i.stencilOp(i.KEEP, i.KEEP, i.REPLACE);
        var r = 1;
        this._tileClippingMaskIDs = {};
        for (var a = 0; a < t.length; a++) {
          var s = t[a],
            n = this._tileClippingMaskIDs[s.id] = r++ << 3;
          i.stencilFunc(i.ALWAYS, n, 248), i.switchShader(this.fillShader, this.calculatePosMatrix(s, e)), i.bindBuffer(i.ARRAY_BUFFER, this.tileExtentBuffer), i.vertexAttribPointer(this.fillShader.a_pos, this.tileExtentBuffer.itemSize, i.SHORT, !1, 8, 0), i.drawArrays(i.TRIANGLE_STRIP, 0, this.tileExtentBuffer.itemCount)
        }
        i.stencilMask(0), i.colorMask(!0, !0, !0, !0), this.depthMask(!0), i.enable(i.DEPTH_TEST)
      ...
      Painter.prototype.render = function (t, e) {
        ...
        for (var r = 0; r < e.length; r++) {
          var a = e[i ? e.length - 1 - r : r],
            ...
            n = [];
          s && (n = s.getVisibleCoordinates(), this.clearStencil(), s.prepare && s.prepare(), s.isTileClipped && this._renderTileClippingMasks(n, s.maxzoom)), i ? (this.gl.disable(this.gl.BLEND), this.isOpaquePass = !0) : (this.gl.enable(this.gl.BLEND), this.isOpaquePass = !1, n.reverse());
          for (var u = 0; u < a.length; u++) {
            var l = a[i ? a.length - 1 - u : u];
            this.currentLayer += i ? -1 : 1, this.renderLayer(this, s, l, n)
          }
          draw.debug(this, n)
        }
      }, Painter.prototype.depthMask = function (t) {
        t !== this._depthMask && (this._depthMask = t, this.gl.depthMask(t))
      }, Painter.prototype.renderLayer = function (t, e, i, r) {
        i.hidden || ("background" === i.type || r.length) && draw[i.type](t, e, i, r)
      }, Painter.prototype.drawStencilBuffer = function () {
        var t = this.gl;
        t.switchShader(this.fillShader, this.identityMatrix), t.stencilMask(0), t.stencilFunc(t.EQUAL, 128, 128), t.bindBuffer(t.ARRAY_BUFFER, this.backgroundBuffer), t.vertexAttribPointer(this.fillShader.a_pos, this.backgroundBuffer.itemSize, t.SHORT, !1, 0, 0), t.uniform4fv(this.fillShader.u_color, [0, 0, 0, .5]), t.drawArrays(t.TRIANGLE_STRIP, 0, this.tileExtentBuffer.itemCount)
      }, Painter.prototype.setDepthSublayer = function (t) {
        var e = 1 - ((1 + this.currentLayer) * this.numSublayers + t) * this.depthEpsilon,
        ...
        var n = this.transform.scale / (1 << e.coord.z) / (e.tileExtent / e.tileSize),
          u = [i[0] / n, i[1] / n, 0],
          l = new Float32Array(16);
        return mat4.translate(l, t, u), l
      }, Painter.prototype.calculatePosMatrix = function (t, e) {
        var i = 4096;
        t instanceof TileCoord && (t = t.toCoordinate());
        var r = this.transform;
        void 0 === e && (e = 1 / 0);
        var a = Math.min(t.zoom, e),
          s = t.column,
          n = t.row,
          u = r.worldSize / Math.pow(2, a),
          l = new Float64Array(16);
        return mat4.identity(l), mat4.translate(l, l, [s * u, n * u, 0]), mat4.scale(l, l, [u / i, u / i, 1]), mat4.multiply(l, r.projMatrix, l), new Float32Array(l)
    ...
    28: [function (require, module, exports) {
      ...
      module.exports = GeoJSONSource, GeoJSONSource.prototype = util.inherit(Evented, {
        ...
        _updateData: function () {
          this._dirty = !1;
          var e = this._data;
          "string" == typeof e && "undefined" != typeof window && (e = urlResolve(window.location.href, e)), this.workerID = this.dispatcher.send("parse geojson", {
            data: e,
            tileSize: 512,
            source: this.id,
    ...
    30: [function (require, module, exports) {
      ...
      function ImageSource(e) {
        ajax.getImage(e.url, function (t, i) {
          t || (this.image = i, this.image.addEventListener("load", function () {
            this.map._rerender()
          }.bind(this)), this._loaded = !0, this.map && (this.createTile(e.coordinates), this.fire("change")))
        }.bind(this))
      }
      var util = require("../util/util"),
        Tile = require("./tile"),
        ...
        createTile: function (e) {
          var t = this.map,
            ...
            a = i.map(function (e) {
              ...
              return new Point(Math.round((t.column - r.column) * n), Math.round((t.row - r.row) * n))
            }),
            o = t.painter.gl,
            u = 32767,
            s = new Int16Array([a[0].x, a[0].y, 0, 0, a[1].x, a[1].y, u, 0, a[3].x, a[3].y, 0, u, a[2].x, a[2].y, u, u]);
          this.tile = new Tile, this.tile.buckets = {}, this.tile.boundsBuffer = o.createBuffer(), o.bindBuffer(o.ARRAY_BUFFER, this.tile.boundsBuffer), o.bufferData(o.ARRAY_BUFFER, s, o.STATIC_DRAW)
        },
        loaded: function () {
    ...
    33: [function (require, module, exports) {
      ...
      function Tile(e, t, i) {
        this.coord = e, this.uid = util.uniqueId(), this.loaded = !1, this.uses = 0, this.tileSize = t, this.sourceMaxZoom = i
      }
      ...
      module.exports = Tile, Tile.prototype = {
        ...
        reloadSymbolData: function (e, t) {
          if (this.buffers) {
            ...
            for (var s in e.elementGroups) this.elementGroups[s] = e.elementGroups[s]
          }
        },
        unloadVectorData: function (e) {
          for (var t in this.buffers) this.buffers[t] && this.buffers[t].destroy(e.gl);
          this.buffers = null
        },
        redoPlacement: function (e) {
          function t(t, i) {
            this.reloadSymbolData(i, e.map.painter), e.fire("tile.load", {
              tile: this
        ...
        hasLayerData: function (e) {
          return Boolean(this.buffers && this.elementGroups[e.ref || e.id] && Object.keys(this.elementGroups[e.ref || e.id]).length)
        }
      };
}, {
      "../data/buffer": 2,
    ...
    34: [function (require, module, exports) {
      ...
      function scanSpans(t, i, o, r, e) {
        ...
        for (var d = t.dx / t.dy, a = i.dx / i.dy, l = t.dx > 0, y = i.dx < 0, c = n; h > c; c++) {
      ...
      module.exports = TilePyramid, TilePyramid.prototype = {
        ...
        findLoadedChildren: function (e, i, t) {
          ...
          for (var r in this._tiles) {
            var n = this._tiles[r];
            if (!(t[r] || !n.loaded || n.coord.z <= e.z || n.coord.z > i)) {
              var s = Math.pow(2, Math.min(n.coord.z, this.maxzoom) - Math.min(e.z, this.maxzoom));
              if (Math.floor(n.coord.x / s) === e.x && Math.floor(n.coord.y / s) === e.y)
                for (t[r] = !0, o = !0; n && n.coord.z - 1 > e.z;) {
                  var d = n.coord.parent(this.maxzoom).id;
                  n = this._tiles[d], n && n.loaded && (delete t[r], t[d] = !0)
                }
            }
          }
          return o
        ...
        update: function (e, i, t) {
          var o, r, n, s = (this.roundZoom ? Math.round : Math.floor)(this.getZoom(i)),
          ...
          for (var c = {}, u = Object.keys(h), f = 0; f < u.length; f++) {
            var _ = u[f];
            r = TileCoord.fromID(_), n = this._tiles[_], n && n.timeAdded > l - (t || 0) && (this.findLoadedChildren(r, a, h) && (h[_] = !0), this.findLoadedParent(r, d, c))
          }
          var v;
        ...
        addTile: function (e) {
          ...
          if (i = this._tiles[t.id], i || (i = this._cache.get(t.id), i && this._redoPlacement && this._redoPlacement(i)), !i) {
            ...
            i = new Tile(t, this.tileSize * r, this.maxzoom), this._load(i)
          }
        ...
        tilesIn: function (e) {
          for (var i = [], t = this.orderedIDs(), o = 0; o < t.length; o++) {
            ...
            n[0].x < r.tileExtent && n[0].y < r.tileExtent && n[1].x >= 0 && n[1].y >= 0 && i.push({
              tile: r,
              minX: n[0].x,
              maxX: n[1].x,
              minY: n[0].y,
      ...
      function VideoSource(e) {
        ajax.getVideo(e.urls, function (t, i) {
          if (!t) {
            ...
            }.bind(this)), this._loaded = !0, this.map && (this.video.play(), this.createTile(e.coordinates), this.fire("change"))
          }
        }.bind(this))
      }
      var util = require("../util/util"),
      ...
      module.exports = VideoSource, VideoSource.prototype = util.inherit(Evented, {
        ...
        createTile: function (e) {
          var t = this.map,
            ...
            a = t.painter.gl,
            u = 32767,
            s = new Int16Array([o[0].x, o[0].y, 0, 0, o[1].x, o[1].y, u, 0, o[3].x, o[3].y, 0, u, o[2].x, o[2].y, u, u]);
          this.tile = new Tile, this.tile.buckets = {}, this.tile.boundsBuffer = a.createBuffer(), a.bindBuffer(a.ARRAY_BUFFER, this.tile.boundsBuffer), a.bufferData(a.ARRAY_BUFFER, s, a.STATIC_DRAW)
        },
        loaded: function () {
    ...
    38: [function (require, module, exports) {
      ...
      module.exports = function (e) {
        ...
        "redo placement": function (e, r) {
          ...
          if (t && t[o]) {
            var a = t[o],
              n = a.redoPlacement(e.angle, e.pitch, e.collisionDebug);
            n.result && r(null, n.result, n.transferables)
        ...
        "parse geojson": function (e, r) {
          var t = function (t, i) {
            ...
            try {
              this.geoJSONIndexes[e.source] = geojsonvt(i, e.geojsonVtOptions)
            } catch (t) {
              return r(t)
            }
            r(null)
    ...
    44: [function (require, module, exports) {
      ...
      "mapbox-gl-style-spec/reference/latest": 123
    }],
    45: [function (require, module, exports) {
      "use strict";

      function Style(e, t) {
        this.animationLoop = t || new AnimationLoop, this.dispatcher = new Dispatcher(Math.max(browser.hardwareConcurrency - 1, 1), this), this.glyphAtlas = new GlyphAtlas(1024, 1024), this.spriteAtlas = new SpriteAtlas(512, 512), this.lineAtlas = new LineAtlas(256, 512), this._layers = {}, this._order = [], this._groups = [], this.sources = {}, this.zoomHistory = {}, util.bindAll(["_forwardSourceEvent", "_forwardTileEvent", "_redoPlacement"], this);
        var r = function (e, t) {
      ...
      "../symbol/glyph_atlas": 59,
      "../symbol/glyph_source": 60,
      "../symbol/sprite_atlas": 65,
      "../util/ajax": 82,
      "../util/browser": 83,
      "../util/dispatcher": 85,
      "../util/evented": 88,
      ...
      "./style_batch": 46,
      "./style_layer": 49,
      "mapbox-gl-style-spec/lib/validate/latest": 120
    }],
    ...
    49: [function (require, module, exports) {
      ...
      "../util/util": 94,
      "./layout_properties": 42,
      "./paint_properties": 43,
      "./style_declaration_set": 48,
      "./style_transition": 50
    }],
    ...
    65: [function (require, module, exports) {
      ...
      function copyBitmap(t, i, e, h, a, s, r, o, n, l, p) {
        var c, x, d = h * i + e,
          R = o * s + r;
        if (p)
          for (R -= s, x = -1; l >= x; x++, d = ((x + l) % l + h) * i + e, R += s)
      ...
      module.exports = SpriteAtlas, SpriteAtlas.prototype = {get debug() {
        ...
        return s.x < 0 ? (console.warn("SpriteAtlas out of space."), s) : s
      ...
      util.extend(Camera.prototype, {
        ...
        easeTo: function (t) {
          ...
          var i = this.transform,
            ...
            f = i.zoomScale(h - r),
            m = "center" in t ? i.project(LngLat.convert(t.center)).sub(e.div(f)) : n,
            g = "center" in t ? null : LngLat.convert(t.around);
          return h !== r && (this.zooming = !0), s !== u && (this.rotating = !0), c !== a && (this.pitching = !0), this.zooming && !g && (g = i.pointLocation(i.centerPoint.add(m.sub(n).div(1 - 1 / f)))), this.fire("movestart"), this._ease(function (t) {
            this.zooming && g ? i.setZoomAround(interpolate(r, h, t), g) : (this.zooming && (i.zoom = interpolate(r, h, t)), i.center = i.unproject(n.add(m.sub(n).mult(t)), o)), this.rotating && (i.bearing = interpolate(s, u, t)), this.pitching && (i.pitch = interpolate(a, c, t)), this.fire("move"), this.zooming && this.fire("zoom"), this.rotating && this.fire("rotate"), this.pitching && this.fire("pitch")
          }, function () {
        ...
        flyTo: function (t) {
          function i(t) {
            var i = (M * M - z * z + (t ? -1 : 1) * T * T * _ * _) / (2 * (t ? M : z) * T * _);
          ...
          var r = this.transform,
            ...
            m = "bearing" in t ? this._normalizeBearing(t.bearing, h) : h,
            g = "pitch" in t ? +t.pitch : u;
          Math.abs(r.center.lng) + Math.abs(c.lng) > 180 && (r.center.lng > 0 && c.lng < 0 ? c.lng += 360 : r.center.lng < 0 && c.lng > 0 && (c.lng -= 360));
          var p = r.zoomScale(f - a),
            d = r.point,
            l = "center" in t ? r.project(c).sub(s.div(p)) : d,
            v = r.worldSize,
            b = t.curve,
            ...
            _ = l.sub(d).mag();
          if ("minZoom" in t) {
            var L = util.clamp(Math.min(t.minZoom, a, f), r.minZoom, r.maxZoom),
              x = z / r.zoomScale(L - a);
            b = Math.sqrt(x / _ * 2)
          }
          var T = b * b,
            ...
            P = function (t) {
              return z * ((n(Z) * o(Z + b * t) - e(Z)) / T) / _
            },
            j = (i(1) - Z) / b;
          if (Math.abs(_) < 1e-6) {
            if (Math.abs(z - M) < 1e-6) return this.easeTo(t);
            var w = z > M ? -1 : 1;
            j = Math.abs(Math.log(M / z)) / b, P = function () {
              return 0
            }, B = function (t) {
              return Math.exp(w * b * t)
            }
          }
          if ("duration" in t) t.duration = +t.duration;
          else {
            var S = "screenSpeed" in t ? +t.screenSpeed / b : +t.speed;
            t.duration = 1e3 * j / S
          }
          return this.zooming = !0, h !== m && (this.rotating = !0), u !== g && (this.pitching = !0), this.fire("movestart"), this._ease(function (t) {
            var i = t * j,
              e = P(i);
            r.zoom = a + r.scaleZoom(1 / B(i)), r.center = r.unproject(d.add(l.sub(d).mult(e)), v), this.rotating && (r.bearing = interpolate(h, m, t)), this.pitching && (r.pitch = interpolate(u, g, t)), this.fire("move").fire("zoom"), this.rotating && this.fire("rotate"), this.pitching && this.fire("pitch")
          }, function () {
            this.zooming = !1, this.rotating = !1, this.pitching = !1, this.fire("moveend")
          }, t), this
        },
    ...
    72: [function (require, module, exports) {
      ...
      DragPan.prototype = {
        ...
        _onDown: function (t) {
          this._ignoreEvent(t) || this.active || (t.touches ? (document.addEventListener("touchmove", this._onMove), document.addEventListener("touchend", this._onTouchEnd)) : (document.addEventListener("mousemove", this._onMove), document.addEventListener("mouseup", this._onMouseUp)), this.active = !1, this._startPos = this._pos = DOM.mousePos(this._el, t), this._inertia = [[Date.now(), this._pos]])
        },
        _onMove: function (t) {
      ...
      DragRotate.prototype = {
        ...
        _onDown: function (t) {
          if (!this._ignoreEvent(t) && !this.active) {
            document.addEventListener("mousemove", this._onMove), document.addEventListener("mouseup", this._onUp), this.active = !1, this._inertia = [[Date.now(), this._map.getBearing()]], this._startPos = this._pos = DOM.mousePos(this._el, t), this._center = this._map.transform.centerPoint;
    ...
    76: [function (require, module, exports) {
      ...
      TouchZoomRotate.prototype = {
        ...
        _onMove: function (t) {
          if (2 === t.touches.length) {
            ...
            if (this._gestureIntent) {
              ...
              "rotate" === this._gestureIntent && (h.bearing = this._startBearing + r), ("zoom" === this._gestureIntent || "rotate" === this._gestureIntent) && (h.zoom = o.transform.scaleZoom(this._startScale * s)), o.stop(), this._drainInertiaBuffer(), this._inertia.push([Date.now(), s, a]), o.easeTo(h)
            } else {
              var u = Math.abs(1 - s) > significantScaleThreshold,
                c = Math.abs(r) > significantRotateThreshold;
              c ? this._gestureIntent = "rotate" : u && (this._gestureIntent = "zoom"), this._gestureIntent && (this._startVec = n, this._startScale = o.transform.scale, this._startBearing = o.transform.bearing)
            }
            t.preventDefault()
          }
        },
        _onEnd: function () {
          ...
          var t = this._inertia,
            e = this._map;
          if (t.length < 2) return void e.snapToNorth();
          var i = t[t.length - 1],
            a = t[0],
            n = e.transform.scaleZoom(this._startScale * i[1]),
            s = e.transform.scaleZoom(this._startScale * a[1]),
            r = n - s,
            o = (i[0] - a[0]) / 1e3,
            h = i[2];
          if (0 === o || n === s) return void e.snapToNorth();
          var u = r * inertiaLinearity / o;
          Math.abs(u) > inertiaMaxSpeed && (u = u > 0 ? inertiaMaxSpeed : -inertiaMaxSpeed);
          var c = 1e3 * Math.abs(u / (inertiaDeceleration * inertiaLinearity)),
            _ = n + u * c / 2e3;
          0 > _ && (_ = 0), e.easeTo({
            zoom: _,
            duration: c,
            easing: inertiaEasing,
            around: e.unproject(h)
          })
        },
        _drainInertiaBuffer: function () {
    ...
    78: [function (require, module, exports) {
      ...
      "../util/util": 94,
      "./handler/box_zoom": 70,
      "./handler/dblclick_zoom": 71,
      "./handler/drag_pan": 72,
      "./handler/drag_rotate": 73,
      "./handler/keyboard": 74,
      "./handler/scroll_zoom": 75,
      "./handler/touch_zoom_rotate": 76
    }],
    79: [function (require, module, exports) {
      ...
      util.extend(Map.prototype, Evented), util.extend(Map.prototype, Camera.prototype), util.extend(Map.prototype, {
        ...
        _setupContainer: function () {
          ...
          var o = this._controlContainer = DOM.create("div", "mapboxgl-control-container", e),
    ...
    80: [function (require, module, exports) {
      ...
      Popup.prototype = util.inherit(Evented, {
        ...
        setText: function (t) {
          return this._createContent(), this._content.appendChild(document.createTextNode(t)), this._update(), this
        },
        setHTML: function (t) {
          this._createContent();
          var e, n = document.createElement("body");
          for (n.innerHTML = t;;) {
    ...
    101: [function (require, module, exports) {
      ...
      var VectorTileFeatureTypes = ["Unknown", "Point", "LineString", "Polygon"],
        operators = {
          ...
          ">=": strictInfix(">="),
          "in": function (t, n) {
            return "(function(){" + Array.prototype.slice.call(arguments, 2).map(function (r) {
              return "if (" + operators["=="](t, n, r) + ") return true;"
            }).join("") + "return false;})()"
          },
          "!in": function () {
    ...
    109: [function (require, module, exports) {
      ...
      "./gl-matrix/common.js": 110,
      "./gl-matrix/mat2.js": 111,
      "./gl-matrix/mat2d.js": 112,
      "./gl-matrix/mat3.js": 113,
      "./gl-matrix/mat4.js": 114,
      "./gl-matrix/quat.js": 115,
      "./gl-matrix/vec2.js": 116,
      "./gl-matrix/vec3.js": 117,
      "./gl-matrix/vec4.js": 118
    }],
      ...
      ! function () {
        ...
        function x(t, i, n, e, h) {
          for (var r, o, a, s, l, u, f, c, d; n > i;) {
            for (n - i > 600 && (r = n - i + 1, o = e - i + 1, a = Math.log(r), s = .5 * Math.exp(2 * a / 3), l = .5 * Math.sqrt(a * s * (r - s) / r) * (0 > o - r / 2 ? -1 : 1), u = Math.max(i, Math.floor(e - o * s / r + l)), f = Math.min(n, Math.floor(e + (r - o) * s / r + l)), x(t, u, f, e, h)), c = t[e], o = i, d = n, p(t, i, e), h(t[n], c) > 0 && p(t, i, n); d > o;) {
              for (p(t, o, d), o++, d--; h(t[o], c) < 0;) o++;
              for (; h(t[d], c) > 0;) d--
            }
            0 === h(t[i], c) ? p(t, i, d) : (d++, p(t, d, n)), e >= d && (i = d + 1), d >= e && (n = d - 1)
          }
        }
        ...
        t.prototype = {
          ...
          search: function (t) {
            ...
            for (var h, r, o, a, s = []; i;) {
              for (h = 0, r = i.children.length; r > h; h++) o = i.children[h], a = i.leaf ? e(o) : o.bbox, c(t, a) && (i.leaf ? n.push(o) : f(t, a) ? this._all(o, n) : s.push(o));
              i = s.pop()
            }
            return n
          },
          collides: function (t) {
            ...
            for (var e, h, r, o, a = []; i;) {
              for (e = 0, h = i.children.length; h > e; e++)
                if (r = i.children[e], o = i.leaf ? n(r) : r.bbox, c(t, o)) {
          ...
          remove: function (t) {
            ...
            for (var i, n, e, h, r = this.data, o = this.toBBox(t), a = [], s = []; r || a.length;) {
              ...
              h || r.leaf || !f(r.bbox, o) ? n ? (i++, r = n.children[i], h = !1) : r = null : (a.push(r), s.push(i), i = 0, n = r, r = r.children[0])
            }
            return this
          },
          toBBox: function (t) {
          ...
          _build: function (t, n, e, h) {
            ...
            var s, l, u, f, c = Math.ceil(o / a),
              x = c * Math.ceil(Math.sqrt(a));
            for (d(t, n, e, x, this.compareMinX), s = n; e >= s; s += x)
              for (u = Math.min(s + x - 1, e), d(t, s, u, c, this.compareMinY), l = s; u >= l; l += c) f = Math.min(l + c - 1, u), r.children.push(this._build(t, l, f, h - 1));
            return i(r, this.toBBox), r
          },
          _chooseSubtree: function (t, i, n, e) {
            for (var h, r, o, s, u, f, c, d;;) {
              if (e.push(i), i.leaf || e.length - 1 === n) break;
              for (c = d = 1 / 0, h = 0, r = i.children.length; r > h; h++) o = i.children[h], u = a(o.bbox), f = l(t, o.bbox) - u, d > f ? (d = f, c = c > u ? u : c, s = o) : f === d && c > u && (c = u, s = o);
              i = s
            }
            return i
          },
          ...
          _chooseSplitIndex: function (t, i, e) {
            var h, r, o, s, l, f, c, d;
            for (f = c = 1 / 0, h = i; e - i >= h; h++) r = n(t, 0, h, this.toBBox), o = n(t, h, e, this.toBBox), s = u(r, o), l = a(r) + a(o), f > s ? (f = s, d = h, c = c > l ? l : c) : s === f && c > l && (c = l, d = h);
            return d
          },
          ...
          _allDistMargin: function (t, i, e, r) {
            ...
            var o, a, l = this.toBBox,
              ...
              f = n(t, e - i, e, l),
              c = s(u) + s(f);
            for (o = i; e - i > o; o++) a = t.children[o], h(u, t.leaf ? l(a) : a.bbox), c += s(u);
            for (o = e - i - 1; o >= i; o--) a = t.children[o], h(f, t.leaf ? l(a) : a.bbox), c += s(f);
            return c
          },
    ...
    134: [function (require, module, exports) {
      ...
      "./lib/vectortile.js": 135,
      "./lib/vectortilefeature.js": 136,
      "./lib/vectortilelayer.js": 137
    }],
